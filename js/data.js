...
const defaultData = {
  users: [
    // ===== PATIENTS =====
    { id:'p1', type:'patient', name:'أحمد محمد', name_en:'Ahmed Mohamed', age:35, gender:'male', country:'مصر', country_en:'Egypt', phone:'+201012345678', email:'ahmed@demo.com', password:'123456', active:true, createdAt:'2025-12-01' },
    { id:'p2', type:'patient', name:'خالد العتيبي', name_en:'Khaled Al-Otaibi', age:42, gender:'male', country:'السعودية', country_en:'Saudi Arabia', phone:'+966501234567', email:'khaled@demo.com', password:'123456', active:true, createdAt:'2025-12-05' },
    { id:'p3', type:'patient', name:'عمر حسن', name_en:'Omar Hassan', age:28, gender:'male', country:'الإمارات', country_en:'UAE', phone:'+971501234567', email:'omar@demo.com', password:'123456', active:true, createdAt:'2025-12-10' },
    { id:'p4', type:'patient', name:'سارة أحمد', name_en:'Sara Ahmed', age:30, gender:'female', country:'الأردن', country_en:'Jordan', phone:'+962791234567', email:'sara@demo.com', password:'123456', active:true, createdAt:'2025-12-15' },
    { id:'p5', type:'patient', name:'محمد التركي', name_en:'Mohammed Al-Turki', age:38, gender:'male', country:'تركيا', country_en:'Turkey', phone:'+905012345678', email:'mohammed@demo.com', password:'123456', active:true, createdAt:'2025-12-20' },
    // ===== DOCTORS =====
    { id:'d1', type:'doctor', name:'د. يوسف إبراهيم', name_en:'Dr. Youssef Ibrahim', specialty:'جراحة تجميل الشعر', specialty_en:'Hair Transplant Surgery', country:'مصر', country_en:'Egypt', city:'القاهرة', city_en:'Cairo', license:'EG-2018-4521', experience:12, email:'youssef@demo.com', password:'123456', phone:'+201234567890', clinicDesc:'عيادة متخصصة في زراعة الشعر بأحدث التقنيات FUE و DHI', clinicDesc_en:'Specialized clinic in hair transplant using latest FUE and DHI techniques', active:true, rating:4.8, ratingCount:45, createdAt:'2025-11-01' },
    { id:'d2', type:'doctor', name:'د. عمر الشمري', name_en:'Dr. Omar Al-Shammari', specialty:'جراحة تجميل الشعر', specialty_en:'Hair Transplant Surgery', country:'السعودية', country_en:'Saudi Arabia', city:'الرياض', city_en:'Riyadh', license:'SA-2016-3210', experience:15, email:'omar.d@demo.com', password:'123456', phone:'+966512345678', clinicDesc:'مركز متقدم لزراعة الشعر مع تقنيات الروبوت', clinicDesc_en:'Advanced hair transplant center with robot techniques', active:true, rating:4.6, ratingCount:38, createdAt:'2025-11-02' },
    { id:'d3', type:'doctor', name:'د. فاطمة القاسمي', name_en:'Dr. Fatima Al-Qassimi', specialty:'طب الجلدية', specialty_en:'Dermatology', country:'الإمارات', country_en:'UAE', city:'دبي', city_en:'Dubai', license:'AE-2019-7845', experience:8, email:'fatima@demo.com', password:'123456', phone:'+971523456789', clinicDesc:'عيادة جلدية وشعر متخصصة في علاج تساقط الشعر', clinicDesc_en:'Dermatology and hair clinic specializing in hair loss', active:true, rating:4.9, ratingCount:52, createdAt:'2025-11-03' },
    { id:'d4', type:'doctor', name:'د. علي حسن', name_en:'Dr. Ali Hassan', specialty:'جراحة تجميل الشعر', specialty_en:'Hair Transplant Surgery', country:'الأردن', country_en:'Jordan', city:'عمان', city_en:'Amman', license:'JO-2017-1567', experience:10, email:'ali@demo.com', password:'123456', phone:'+962781234567', clinicDesc:'مركز رائد في زراعة الشعر بتقنية FUE', clinicDesc_en:'Leading center in FUE hair transplant', active:true, rating:4.5, ratingCount:29, createdAt:'2025-11-04' },
    { id:'d5', type:'doctor', name:'د. محمد أوز', name_en:'Dr. Mehmet Oz', specialty:'جراحة تجميل الشعر', specialty_en:'Hair Transplant Surgery', country:'تركيا', country_en:'Turkey', city:'إسطنبول', city_en:'Istanbul', license:'TR-2015-9823', experience:18, email:'mehmet@demo.com', password:'123456', phone:'+905323456789', clinicDesc:'أشهر عيادة زراعة شعر في إسطنبول', clinicDesc_en:'Most famous hair transplant clinic in Istanbul', active:true, rating:4.7, ratingCount:89, createdAt:'2025-11-05' },
    { id:'d6', type:'doctor', name:'د. نور الدين', name_en:'Dr. Noureddine', specialty:'جراحة التجميل', specialty_en:'Cosmetic Surgery', country:'مصر', country_en:'Egypt', city:'الإسكندرية', city_en:'Alexandria', license:'EG-2020-3344', experience:6, email:'nour@demo.com', password:'123456', phone:'+201134567890', clinicDesc:'عيادة حديثة لزراعة الشعر مع متابعة شاملة', clinicDesc_en:'Modern hair transplant clinic with comprehensive follow-up', active:true, rating:4.3, ratingCount:15, createdAt:'2025-11-06' },
    { id:'d7', type:'doctor', name:'د. سامي الكويتي', name_en:'Dr. Sami Al-Kuwaiti', specialty:'جراحة تجميل الشعر', specialty_en:'Hair Transplant Surgery', country:'السعودية', country_en:'Saudi Arabia', city:'جدة', city_en:'Jeddah', license:'SA-2014-5567', experience:20, email:'sami@demo.com', password:'123456', phone:'+966533456789', clinicDesc:'خبير زراعة شعر بخبرة 20 عاماً', clinicDesc_en:'Hair transplant expert with 20 years experience', active:true, rating:4.9, ratingCount:67, createdAt:'2025-11-07' },
    { id:'d8', type:'doctor', name:'د. ليلى الأردنية', name_en:'Dr. Layla Al-Urduni', specialty:'طب الجلدية', specialty_en:'Dermatology', country:'الأردن', country_en:'Jordan', city:'إربد', city_en:'Irbid', license:'JO-2021-8890', experience:5, email:'layla@demo.com', password:'123456', phone:'+962771234567', clinicDesc:'متخصصة في علاج تساقط الشعر بالحقن المجهري', clinicDesc_en:'Specialist in micro-injection hair loss treatment', active:true, rating:4.4, ratingCount:22, createdAt:'2025-11-08' }
  ],
  cases: [
